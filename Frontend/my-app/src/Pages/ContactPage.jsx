...
const ContactPage = () => {
 ...
 {/* contact -----input for forms --------- */}
  ...
  <Input placeholder='Type Receiver Email' width="90%"  focusBorderColor="white"  m="20px 0px" color="white"  value={state.to} />

  <Input placeholder='Type Sender Email' width="90%"  focusBorderColor="white" m="20px 0px" color="white" value={state.from} />

  <Textarea placeholder='Type your message...' width="90%" focusBorderColor="white" m="30px 0px" color="white" value={state.text}  />
